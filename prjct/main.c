...
void alphabet(){
    ...
    n=length(characters);
    for (i=0;i<n;i++){
        if((characters[i]=='a') || (characters[i]=='e') || (characters[i]=='i') || (characters[i]=='0') || (characters[i]=='u') || (characters[i]=='A') || (characters[i]=='E') ||  (characters[i]=='I') ||  (characters[i]=='O') || (characters[i]=='U')){
